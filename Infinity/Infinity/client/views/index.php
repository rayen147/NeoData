		...
		<div class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">				
					<a class="navbar-brand" href="index.html"><h1>SNCT</h1></a>
					...
					<ul class="nav navbar-nav">
						...
						<li>
							<?php if ($user == false)  {?>
								...
								<?php } else {?>
									<a onclick="window.location.href='../controller/logout.php'"  data-toggle="modal" data-target="#authModal" data-hover="dropdown" data-whatever="@mdo">Se déconnecter</a>
									<?php }?>
								</li>
								<?php if($user == true) {?>
									<li class="dropdown">
		...
		<section id="portfolio" class="page-section nopaddingbottom">
			...
			<div>
				<ul id="portfolio-categories" class="filter clearfix fade-down">
					...
					<li><a href="#" class="btn btn-success" data-filter=".brand-design">Brand Design</a></li>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<form class="pt-3" method="post" action="../controller/login.php">
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<form class="pt-3" method="post" action="../controller/register.php">
					<div class="form-group">
	...
	<div class="modal fade" id="resetPasswordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<form class="pt-3" method="post" action="../controller/resetPassword.php">
					<div class="form-group">
