...
<?php
  ...
  if (isset($_GET['search'])) {
    $listeGares=$gare->Affichergare($search);
  
  } else {
  
    $listeGares=$gare->affichergaretri($order , $by , $type );
  }
...
<?php } ?>
	...
	<section class="textdivider single-post-header">
		<div class="container">
			<h1 class="fade-down">All gares</h1>
			<hr class="mb60">
		</div>
	</section>
	...
	<div id="content-wrapper">		
        ...
        <table class="table bg-white">
            <thead>
                <tr>
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'num'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                  } else {
                    echo "asc";
                  } ?>">Id</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'nom'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Nom</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'ville'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Ville</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'nbr_quai'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Nbr de quais</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'etat'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Etat</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allGares.php?order=<?php echo true ?>&by=<?php echo 'num_trajet'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Num trajet</a>
            ...
            <?PHP
            foreach($listeGares as $row){
                ?>
                <tr>
                    <td><?PHP echo $row['num']; ?></td>
                    <td><?PHP echo $row['nom']; ?></td>
                    <td><?PHP echo $row['ville']; ?></td>
                    <td><?PHP echo $row['nbr_quai']; ?></td>

                    <td><?PHP echo $row['etat']; ?></td>
                    <td><?PHP echo $row['num_trajet']; ?></td>
