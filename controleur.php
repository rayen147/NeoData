...
<?php
  include "../../controller/ControleurC.php";


  $Controleur=new ControleurC();

$listeControleurs=$Controleur->afficherControleur();
...
<?php } ?>
	...
	<section class="textdivider single-post-header">
		<div class="container">
			<h1 class="fade-down">All Controleurs</h1>
			<hr class="mb60">
		</div>
	</section>
	...
	<div id="content-wrapper">		
        ...
        <table class="table bg-white">
            ...
            <?PHP
            foreach($listeControleurs as $row){
                ?>
                <tr>
