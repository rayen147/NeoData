            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <br>
                  <a href=" http://localhost/ProjetWeb/View/yiyi/template/pages/forms/trichauffeur.php  ">
                <input class="btn btn-danger"  type="submit" title="tri" Value="trier" border="0" name="tri"> </a>
                <a href=" http://localhost/ProjetWeb/View/yiyi/template/pages/forms/chercherchauffeur.php  ">
