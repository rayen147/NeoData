...
<?php
  ...
  if (isset($_GET['search'])) {
    $listetrajets=$trajet->affichertrajet($search);
  
  } else {
  
    $listetrajets=$trajet->affichertrajetTri($order , $by , $type );
  }
...
<?php } ?>
	...
	<section class="textdivider single-post-header">
		<div class="container">
			<h1 class="fade-down">All trajets</h1>
			<hr class="mb60">
		</div>
	</section>
	...
	<div id="content-wrapper">		
        ...
        <table class="table bg-white">
            <thead>
                <tr>
                <th scope="col">
                  <a style="color: inherit;" href="allTrajets.php?order=<?php echo true ?>&by=<?php echo 'id_t'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                  } else {
                    echo "asc";
                  } ?>">Id</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allTrajets.php?order=<?php echo true ?>&by=<?php echo 'depart'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Depart</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allTrajets.php?order=<?php echo true ?>&by=<?php echo 'terminus'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Terminus</a>
                ...
                <th scope="col">
                  <a style="color: inherit;" href="allTrajets.php?order=<?php echo true ?>&by=<?php echo 'nbr_station'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Nombre de stations</a>
                    </th>
                <th scope="col">
                  <a style="color: inherit;" href="allTrajets.php?order=<?php echo true ?>&by=<?php echo 'horaire'?>&type=<?php if ($type === "" || $type === "asc"){
                    echo "desc";
                    } else {
                      echo "asc";
                    } ?>">Horaire</a>
            ...
            foreach($listetrajets as $row){
                ...
                <tr>
                    ...
                    <td><a href="./ticket.php">Réserver</a></td>
