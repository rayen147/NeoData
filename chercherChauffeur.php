...
$Chauffeurs=$ChauffeurC-> afficherChauffeur();
//echo $_GET["Chauffeur"];

/*if( isset($_POST['search'])){

    $list=$ChauffeurC-> afficher_Cha$Chauffeur(15); 
}*/
?>
...
<select name="Chauffeur" id="Chauffeur" >
    <?php foreach($Chauffeurs as $Chauffeur){
        ...
        <option 
        value="<?= $Chauffeur['id'] ?>"
        <?php if(isset($_POST['search']) && $Chauffeur["id"]==$_POST["Chauffeur"]){ ?>
            selected
            <?php } ?>
...
$list=$ChauffeurC-> Select_chauffeur($Chauffeur['id']);} 
...
<tbody  >
 ...
 <?php if(isset($_POST['search'])) { ?>
       ...
       foreach(  $list as $Chauffeur) {
          ...
          <td > <?php echo  $Chauffeur['prenom'] ?> </td>
          <td > <?php echo  $Chauffeur['email'] ?>     </td>
          <td > <?php echo  $Chauffeur['num'] ?>     </td>
          <td><img class="img-responsive img-thumbnail "  src=../../../<?PHP echo $Chauffeur['img'] ?> ></td>
          <td > <?php echo  $Chauffeur['salaire'] ?>     </td>
       </tr>
