<?PHP
include_once "ChauffeurC.php";
include_once "commentaire.php";
$commentaire=null;
$error="";
$chauffeur1C=new ChauffeurC();
$listeChauffeur=$chauffeur1C->afficherChauffeur();
if(isset($_POST["texte"]))
{
       if(!empty($_POST["texte"]))
       {
        ...
        $commentaire=new  Commentaire($_POST['texte']) ;
        $chauffeur1C->ajouterCommentaire($commentaire);
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 blog-item mb100 wow match-height">
                            <div class="row">
                            <?PHP
     					 foreach($listeChauffeur as $row){    
     					 ?>
                                <div class="col-xs-12">
                                    <div class="hover-item mb30">
                                        <img class="img-responsive smoothie"  alt=""  <?PHP echo "<img src=\"images/{$row['img']}\">"?> </a>
                          
                                        <div class="overlay-item-caption smoothie"></div>
                                        <div class="hover-item-caption smoothie">
                                        <h6></h6>
                                    <h6><?PHP echo $row['prenom'];  ?></h6>                                        </div>
                                    </div>
                                    <h2 class="post-title"><?PHP echo $row['nom'];  ?></h2>
                                   
<p>Prenom :<?PHP echo $row['prenom'];  ?></p>  
<p> Numero de téléphone :<?PHP echo $row['num'];  ?></p> 

<form  method="POST" action="affichageCommentaire.php" class="form-horizontal">
<textarea type="text" name="texte" id="texte"></textarea>
<a href=" http://localhost/ProjetWeb/View/Front/affichagecommentaire.php"> 
